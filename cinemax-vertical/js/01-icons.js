...
var IC={
 ...
 star:sv('<path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>',12,'currentColor').replace('stroke-width="1.9"','stroke-width="0"'),
 chevUp:sv('<path d="M18 15l-6-6-6 6"/>',22),
 chevDown:sv('<path d="M6 9l6 6 6-6"/>',22),
 download:sv('<path d="M12 3v12M7 11l5 5 5-5M5 21h14"/>',18),
 send:sv('<path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"/>',18),
 shuffle:sv('<path d="M16 3h5v5M4 20L21 3M21 16v5h-5M15 15l6 6M4 4l5 5"/>',19),
 mute:sv('<path d="M11 5L6 9H2v6h4l5 4V5z"/><path d="M23 9l-6 6M17 9l6 6"/>',20),
 sound:sv('<path d="M11 5L6 9H2v6h4l5 4V5z"/><path d="M15.54 8.46a5 5 0 010 7.07M19.07 4.93a10 10 0 010 14.14"/>',20)
};
